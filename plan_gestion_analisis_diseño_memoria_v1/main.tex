...
Por otro lado, también realizaron una formación relacionada con las distintas \textbf{APIs web}, concretamente el tutorial \textit{Introducción a las APIs web} de MozillaDeveloper \cite{apisweb}.
