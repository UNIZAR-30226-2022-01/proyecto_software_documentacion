...
En relación al equipo del frontend de \textbf{React}, hemos seguido de forma correcta el plan establecido. De cara a entrar en contacto con el framework, hemos realizado un proyecto de prueba para poner en práctica las competencias adquiridas y desplegar una primera aplicación muy sencilla. También hemos investigado y probado diversos paquetes o librerías adicionales de \textit{React}, y hemos aprendido a realizar las conexiones con la API y gestionar cookies. Cabe resaltar que los objetivos que planteamos en la planificación inicial los hemos cumplido y esto nos permitió poder empezar a trabajar y desarrollar el frontend con una buena base de conocimientos. \\
